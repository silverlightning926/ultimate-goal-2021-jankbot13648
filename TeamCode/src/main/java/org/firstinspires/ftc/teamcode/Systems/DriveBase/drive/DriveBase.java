package org.firstinspires.ftc.teamcode.Systems.DriveBase.drive;
...
import static org.firstinspires.ftc.teamcode.Systems.DriveBase.drive.DriveConstants.MOTOR_VELO_PID;
import static org.firstinspires.ftc.teamcode.Systems.DriveBase.drive.DriveConstants.RUN_USING_ENCODER;
import static org.firstinspires.ftc.teamcode.Systems.DriveBase.drive.DriveConstants.TRACK_WIDTH;
import static org.firstinspires.ftc.teamcode.Systems.DriveBase.drive.DriveConstants.encoderTicksToInches;
import static org.firstinspires.ftc.teamcode.Systems.DriveBase.drive.DriveConstants.kA;
import static org.firstinspires.ftc.teamcode.Systems.DriveBase.drive.DriveConstants.kStatic;
import static org.firstinspires.ftc.teamcode.Systems.DriveBase.drive.DriveConstants.kV;
...
public class DriveBase extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(1.6, 0.01, 0.5);
    ...
    public void turnAsync(double angle, double maxAngVelocity, double maxAngAccel) {
        double heading = getPoseEstimate().getHeading();
    ...
    public void turn(double angle, double maxAngVelocity, double maxAngAccel) {
        turnAsync(angle, maxAngVelocity, maxAngAccel);
        waitForIdle();
    }
